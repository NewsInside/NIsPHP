...
{
  u16 pal = gbSgbPacket[1] & 511; //READ16LE((((u16 *)&gbSgbPacket[1]))) & 511;
  
  memcpy(&gbPalette[0], &gbSgbSCPPalette[pal*4], 4 * sizeof(u16));
  
  pal = gbSgbPacket[3] & 511; // READ16LE((( (u16 *)&gbSgbPacket[3]) )) & 511;
  memcpy(&gbPalette[4], &gbSgbSCPPalette[pal*4], 4 * sizeof(u16));
  
  pal = gbSgbPacket[5] & 511; // READ16LE((((u16 *)&gbSgbPacket[5])))&511;
  memcpy(&gbPalette[8], &gbSgbSCPPalette[pal*4], 4 * sizeof(u16));

  pal = gbSgbPacket[7] & 511; //READ16LE((((u16 *)&gbSgbPacket[7])))&511;
