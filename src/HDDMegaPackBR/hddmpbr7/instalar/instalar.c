...
const char *versao_megapack = "7.1 - EXPLOIT JPN";
const char *versao_instalador = "1.1";
...
{   
   ...
   scr_printf("(C)05/2006 por: Thiago Ataide (thataide)\n");
   ...
   scr_printf("Instalando o PS2 HDD MegaPack BR %s! Aguarde... ", versao_megapack);
...
int instalaBootLoader(void) {
   ...
   //if(ret < 0) return ret;
   //ret = copiaArquivo("cdfs:/APPS/LAUNCHELF.CNF", "mc0:/BOOT/LAUNCHELF.CNF");
