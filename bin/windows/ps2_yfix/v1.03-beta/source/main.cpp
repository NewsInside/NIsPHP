...
#endif
{
	...
	SysPrintf("PS2 Y-FIX\r\n");
	SysPrintf("Patching Engine V1.10 - 16 July, 2009\r\n");
	SysPrintf("By Earl\r\n");
	SysPrintf("\r\n");
	SysPrintf("Please report any bugs or suggestions to zets55rag@verizon.net\r\n");
	SysPrintf("Based on ps2 pal to ntsc y-fix by jaytee\r\n");
	SysPrintf("\r\n");
	...
	if (argc<2)
	{
		SysPrintf("Usage: ps2 yfix <elf file>\r\n");
		Exit(0);
	}
